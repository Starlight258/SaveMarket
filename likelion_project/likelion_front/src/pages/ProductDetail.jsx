...
function ProductDetail() {
  ...
  return (
    <>
      ...
      <p>{id}</p>
      <DetailInfo>
        <DetailImg src={aData.product_image} />

        <DetailContent>
          <DetailName>{aData.name}</DetailName>
          <DetailBox>
            <DetailText>진행률: {aData.people}% 달성</DetailText>
            <DetailText>목표 인원: {aData.target}명</DetailText>
            <DetailText>상품 금액: {aData.price}원</DetailText>
            <DetailText>수령 장소: {aData.place}</DetailText>
            ...
            <DetailText>하고 싶은 말: {aData.description}</DetailText>
          </DetailBox>
        </DetailContent>
      </DetailInfo>
